...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        validation_alias=AliasChoices("POSTGRES_AUTH_URL", "database_url")
    )
    encryption_key: str = Field(
        validation_alias=AliasChoices("PRIVATE_KEY", "encryption_key")
    )
    ...
    redis_user: str = Field(
        default="", validation_alias=AliasChoices("REDIS_USER", "redis_user")
    )
